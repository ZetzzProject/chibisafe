...
import {
    FileTrigger
} from '@/components/ui/file-trigger';
import {
    getSignedUrl,
    processDropItem
} from '@/lib/dropzone';
...
export const UploadTrigger = forwardRef < HTMLInputElement,
    FileTriggerPropsWithAlbumUuid > ((props, ref) => {
        const {
            children,
            ...additionalProps
        } = props;
        ...
        const {
            ...
            albumUuid: props.albumUuid ?? undefined
        });
        ...
        const onSelect = useCallback(
            async (files: FileList | null) => {
                    ...
                    for (const item of files) {
                        ...
                        if (!settings?.useNetworkStorage || settings?.useHFStorage) {
